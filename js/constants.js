...
export const APP_VERSION = "0.3.27"; // Daily merge 2026-06-09 - Verified: all critical features present (tap tempo, auto-save, crash recovery, sidechain routing, MIDI import/export, automation, sequence tools, undo captures). snaw remains the complete super-repo.
