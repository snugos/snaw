...
export const APP_VERSION = "0.4.32"; // v0.4.30 Daily Merge - Added tap tempo constants, verified all features and bug fixes // v0.4.27 Daily Merge // v0.4.26 Metronome Accent Pattern Bug Fix Check - No changes required (all features already present, no bugs found)
