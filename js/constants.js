...
export const APP_VERSION = "0.3.28"; // Daily merge 2026-06-10 - Repository sync verified. All critical features present in snaw (tap tempo, auto-save, crash recovery, sidechain routing, MIDI import/export, automation, sequence tools, undo captures). snaw remains the complete super-repo.
